...
type GreetServiceClient interface {
	...
	GreetWithErr(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponse, error)
}
...
func (c *greetServiceClient) GreetWithErr(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponse, error) {
	out := new(GreetResponse)
	err := c.cc.Invoke(ctx, "/greet.GreetService/GreetWithErr", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreetServiceServer interface {
	...
	GreetWithErr(context.Context, *GreetRequest) (*GreetResponse, error)
...
func (UnimplementedGreetServiceServer) GreetWithErr(context.Context, *GreetRequest) (*GreetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GreetWithErr not implemented")
}
...
func _GreetService_GreetWithErr_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GreetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreetServiceServer).GreetWithErr(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/greet.GreetService/GreetWithErr",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServiceServer).GreetWithErr(ctx, req.(*GreetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GreetWithErr",
			Handler:    _GreetService_GreetWithErr_Handler,
		},
	},
